...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // 3. Fetch all items currently assigned to this department
    $items_sql = "SELECT it.item_id, it.item_name, it.item_model, it.item_manufacturer, it.serial_number, ia.date_assigned 
